#!/usr/bin/env bash
# Bump version, build a signed AAB, and publish Learn Nah to Google Play.
#
# Usage:
#   ./scripts/release-play.sh                     # bump +build, production (100%)
#   ./scripts/release-play.sh --name 2.2.0        # also set the version name
...
echo "==> Done. Learn Nah uploaded to '$TRACK'. Play review usually takes a few hours."
